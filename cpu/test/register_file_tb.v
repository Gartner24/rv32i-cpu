...
initial begin
    ...
    rd=5'd0; write_data=32'hDEADBEEF;
    @(posedge clk); #1;
    rs1=5'd0; rs2=5'd0; #1;
    ...
    // en=0 blocks write
    en=0; rd=5'd5; write_data=32'hDEADBEEF; reg_write=1;
    @(posedge clk); #1;
    rs1=5'd5; #1;
    if (read_data1!==32'd0) begin $display("FAIL: en=0 should block write got %0h", read_data1); errors=errors+1; end

    // reg_write=0 blocks write
    en=1; reg_write=0; rd=5'd6; write_data=32'hCAFEBABE;
    @(posedge clk); #1;
    rs1=5'd6; #1;
    if (read_data1!==32'd0) begin $display("FAIL: reg_write=0 should block write got %0h", read_data1); errors=errors+1; end
